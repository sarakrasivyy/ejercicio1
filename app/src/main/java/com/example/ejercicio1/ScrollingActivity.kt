...
class ScrollingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btbar.setNavigationOnClickListener {
            Snackbar.make(binding.root, message_action_sucess, Snackbar.LENGTH_LONG)
                .setAnchorView(binding.btbar).show()

        }

        binding.contenido.btSkin!!.setOnClickListener {
            binding.contenido.mcontenido!!.visibility = View.GONE
        }
        ...
        binding.contenido.btcomprar!!.setOnClickListener {
            ...
            Glide.with(this).load("https://www.jairogarciarincon.com/img/clases/1379.jpg")
                .diskCacheStrategy(
                    DiskCacheStrategy.ALL).centerCrop().into(binding.contenido.imTX)

            binding.contenido.cbEnablepass.setOnClickListener {
                binding.contenido.etpaswor.isEnabled = !binding.contenido.etpaswor.isEnabled
            }
